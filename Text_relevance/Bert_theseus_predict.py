...
'''
__file__    :   Bert_theseus_predict.py
__time__    :   2022/06/17 17:26:22
__author__  :   yangning
...
from Text_relevance.bert_of_theseus import BertForSequenceClassification
from torch.utils.data import DataLoader, RandomSampler, SequentialSampler, TensorDataset
import numpy as np
import copy

class BertTheseusPredict:
    def __init__(self):
        ...
        print ("Bert Theseus load finish !")
